...
def demo_test():
    ...
    with open('./list/PickupThrowObject.txt', 'r') as f:
        lines = f.read().split('\n')
    ...
    logits, fc2 = c3d_ucf101(inputs=inputs, training=training, weights=weights)
    print(tf.shape(fc2))
        ...
        for epoch in range(1):
            ...
            for idx, tst_file in enumerate(tst_files):
                ...
                if bidx == NumBatch:
                    ...
                    acc, score, fc = sess.run([acc_opt, logits, fc2], feed_dict=feeds)
